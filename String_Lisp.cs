...
//12-02-2024 начали изучать java script
namespace Autocad_Wpf_Autolip_Pipe_12_02_2024
{
    public static class String_Lisp
    {
        public static string begin = "; Начало оптимизации прорисовки кабелей по трубам" + "\n" +
             ...
             "(initget 133); ограничения ввода данных 1 пустой ввод +4 ввод отриц " + "\n" +
              ...
              "(setq y1(getreal \"input Y:\")); координата Y" + "\n" +
              "(setq x1 (getreal \"input X:\")) ; координата X" + "\n" +
              "(setq radpat (getreal \"input rad pipe:\")) ; радиус патрубка" + "\n" +
    ...
    "(foreach circl3" + "\n" +
     " '(; Список диаметров берем из кабельного журнала - впоследствии база данных";
       public static string diam =(" 15.2 15.3 15.4 15.5" + "\n");
        public static string middle = (" )" + "\n" +
            "(setq lay(nth N_lay" + 
            "         '(" + "\n" );
        public static string laystr = ("\"333\" \"444\" \"555\" \"666\" " + "\n");
